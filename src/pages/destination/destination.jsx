    ...
    <>
      ...
      ">
        ...
        <div className="md:w-3/5 w-3/5 lg:w-[28rem] lg:h-[28rem] mx-auto mb-8">
          <img className="" src={data.destinations[active].images.png} alt="planet moon" /> 
        </div> 
          ...
          <div className="flex justify-center  text-white  leading-normal 
            md:text-80
            lg:text-100 
          ...
          <div className=" lg:w-[28rem]">
            <p className="text-light text-center lg:text-left text-15 pb-8 leading-7
          ...
          <div className=" md:flex md:flex-row md:justify-center pt-8 lg:text-left text-center">
            <div className="text-light md:pr-16">
              ...
              <p className=" text-white text-28 uppercase font-serif pb-4
                md:text-28
              ">
